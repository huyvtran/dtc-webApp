...
export class AppConfig{ 
    ...
    public static add_img = 'assets/images/customer/lipin.png';//添加物料
    //客户管理
    ...
    public static version = 'version 1.6.9'; //版本号
    ...
    //    merchandisetList:'product/productInfo/lists',  //商品列表接口
       ...
       merchandisetList:'product/productInfo/private/lists',
       merchandisetListPublic: 'product/productInfo/lists',
    //    merchandDetails:'product/productInfo/',  //商品详情接口   
       merchandDetails:'product/productInfo/private/detail/',
    ...
    //    addCustomer: 'member/web/add/member', //添加客户
       ...
       personMoneyList:'member/front/query/member/paging',//客户按消费金额排序
       customerCurve:'order/salesStatistics/getCustomerData ',  //客户消费趋势
       //购买记录
       ...
       // 收货
        ...
        completedList: 'order/query/order/finish/list/app', // 已完成列表
        rejectList: 'order/query/order/reject/list/app', // 被驳回列表
        orderDetails:'order/app/get/online/order/info/',     //订单详情
        orderDetail:'order/get/online/order/info/resubmit/',//新订单详情
        ...
        updateDiscount:'order/calculate/discount/money',//提交优惠价
        updateDiscount2: 'order/calculate/discount/money/2',//提交优惠价
        mdApprovalInquire:'order/judge/examine/md/back/',//查询是否需要md审批
        confirmApprovalInfo:'order/update/order/status/dtc/pass/example',//dtc确认审批
        MDconfirmApproval:'order/update/order/status/ceo/1',//MD确认审批
        getMDList: 'company/employeeController/get/employee/role', //查询MD列表
        rejectOrder:'order/dtc/reject/order',//dtc驳回订单
        MDRejectOrder:'order/ceo/reject/order',//MD驳回订单
        refundOrder: 'order/dtc/pass/refund/',//dtc提交退货
        rejectReason:'order/reject/refund/order/dtc',//驳回退款
        sheng:'order/city/treeList',
        numberShopping:'order/query/shopping/cart/app/count',//购物车数量
        ...
        materialList:'marketing/eventProduct/queryTemplate/',   // 物料清单
        wareHouse:"product/activity/warehouse",    // 获取仓库
        wareHouseList:'product/activity/lists',      // 根据仓库和产品 获得库存
        material:'marketing/eventProduct/', //物料清单
        searchMaterial: 'marketing/eventProduct/query', //搜索物料清单
        activity:'order/calculate/discount/money/activity',//活动下单优惠价
        activity2:'order/calculate/discount/money/activity/2',//活动重新下单优惠价
        activityExamination:'order/app/judge/examine/activity',//活动单审批

        //消息模块
        getMessageList: 'company/pushController/query', // post 消息列表
        getMessageNews:'company/pushController/query/news', //get最新消息
        getMessagePush:'company/pushController/check/push',//是否有推送消息

        //报表模块
        getSaleHeaderData: "order/salesStatistics/getSaleHeaderData/", // 销售团队领导0月数据  1年数据
        getSaleData: "order/salesStatistics/getSaleData/", // 销售人员数据0月数据  1年数据
        customersSort:"order/salesStatistics/getSaleCustomerList", //客户排名
        marketSort:"order/salesStatistics/getSaleList", //销售排名
        getCustomerListBySale:'order/salesStatistics/getCustomerListBySale', //销售团队下的 客户列表
        getSaleChartsData:'order/salesStatistics/getSaleChartsData',  //销售每月销售数据（用户图表）
        getLeaderData:'order/salesStatistics/getLeaderData', //Training Team Head表头数据
        getLeaderTableData:'order/salesStatistics/getLeaderTableData' //Training Team Head销售数据
